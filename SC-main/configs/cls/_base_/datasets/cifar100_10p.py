...
data = dict(
    ...
    workers_per_gpu=2,
    train=dict(type=dataset_type,
               data_prefix='data_use/cifar-100/train_pro',
               ann_file='data_use/cifar-100/train_10p.list',
               pipeline=train_pipeline),
    val=dict(type=dataset_type,
             data_prefix='data_use/cifar-100/test_pro',
             ann_file='data_use/cifar-100/test.list',
             pipeline=test_pipeline),
    test=dict(type=dataset_type,
              classes=CLASSES,
              data_prefix='data_use/cifar-100/test_pro',
